...
const genericAreaEntries = Object.entries(areaLabels).filter(
  ([slug]) => !manualAreaSlugs.has(slug)
);
...
const genericSuburbSlugs = suburbSlugs.filter(
  (slug) => !manualSuburbSlugs.has(slug)
);
      ...
      <Routes>
        ...
        {genericAreaEntries.map(([slug, label]) => (
          <Route
            ...
            element={
              <GenericLanding
                title={`Pergola Builders ${label}`}
                description={`Professional pergola builders in ${label}, Sydney Metropolitan Area.`}
                canonicalPath={`/pergola-builders-${slug}/`}
              />
            }
          />
        ))}
        ...
        <Route
          path="/pergola-builders-eastern-suburbs/"
          element={<EasternSuburbs />}
        />
        <Route
          path="/pergola-builders-northern-beaches/"
          element={<NorthernBeaches />}
        />
        <Route path="/pergola-builders-north-shore/" element={<NorthShore />} />
        <Route
          path="/pergola-builders-hills-district/"
          element={<HillsDistrict />}
        />
        <Route path="/pergola-builders-ryde/" element={<Ryde />} />
        <Route path="/pergola-builders-inner-west/" element={<InnerWest />} />
        <Route
          path="/pergola-builders-western-sydney/"
          element={<WesternSydney />}
        />
        ...
        <Route
          path="/pergola-builders-north-west-sydney/"
          element={<NorthWestSydney />}
        />
        <Route
          path="/pergola-builders-south-sydney/"
          element={<SouthSydney />}
        />
        <Route
          path="/pergola-builders-sutherland-shire/"
          element={<SutherlandShire />}
        />
        ...
        {genericSuburbSlugs.map((slug) => (
          <Route
            ...
            element={
              <GenericLanding
                title={`Pergola Installers in ${slug.replace(/-/g, " ")}`}
                description={`Trusted pergola installers in ${slug.replace(
                  /-/g,
                  " "
                )} and surrounding Sydney suburbs.`}
                canonicalPath={`/pergola-installers-in-${slug}/`}
              />
            }
          />
        ))}
        ...
        <Route
          path="/pergola-installers-in-dover-heights/"
          element={<DoverHeights />}
        />
        <Route
          path="/pergola-installers-in-longueville/"
          element={<Longueville />}
        />
        <Route
          path="/pergola-installers-in-northbridge/"
          element={<Northbridge />}
        />
        <Route
          path="/pergola-installers-in-castlecrag/"
          element={<Castlecrag />}
        />
        <Route
          path="/pergola-installers-in-hunters-hill/"
          element={<HuntersHill />}
        />
        <Route path="/pergola-installers-in-roseville/" element={<Roseville />} />
        <Route path="/pergola-installers-in-lindfield/" element={<Lindfield />} />
        <Route
          path="/pergola-installers-in-wahroonga/"
          element={<Wahroonga />}
        />
        <Route
          path="/pergola-installers-in-normanhurst/"
          element={<Normanhurst />}
        />
        <Route
          path="/pergola-installers-in-turramurra/"
          element={<Turramurra />}
        />
          ...
          <Route
            ...
            element={
              <GenericLanding
                ...
                description="Pool design, planning and outdoor living guide for Sydney homeowners."
                canonicalPath={`/${slug}/`}
              />
            }
          />
        ...
        <Route
          path="/modern-pergola-ideas/"
          element={<ModernPergolaIdeas />}
        />
        <Route path="/outdoor-pergolas/" element={<OutdoorPergolas />} />
        <Route
          path="/outdoor-pergola-ideas/"
          element={<OutdoorPergolaIdeas />}
        />
        ...
        <Route
          path="/aluminium-pergola/"
          element={<AluminiumPergolaSydney />}
        />
        ...
        <Route
          path="/retractable-pergola/"
          element={<RetractablePergola />}
        />
        <Route
          path="/retractable-roof-pergola/"
          element={<RetractableRoofPergola />}
        />
        <Route path="/cantilever-pergola/" element={<CantileverPergola />} />
        <Route path="/pergola-brackets/" element={<PergolaBrackets />} />
        <Route
          path="/how-to-build-a-pergola-attached-to-the-house/"
          element={<HowToBuildAttachedPergola />}
        />
        <Route
          path="/how-to-attach-a-pergola-to-a-house-with-gutters/"
          element={<AttachPergolaWithGutters />}
        />
        <Route
          path="/pergola-builders-near-me/"
          element={<PergolaBuildersNearMe />}
        />
        <Route
          path="/how-much-does-a-pergola-cost/"
          element={<HowMuchDoesPergolaCost />}
        />
        <Route path="/pool-pergola/" element={<PoolPergola />} />
        <Route
          path="/pergola-attached-to-house/"
          element={<PergolaAttachedToHouse />}
        />
